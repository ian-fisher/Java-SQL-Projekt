...
INSERT INTO Kategorie (Name, Steuerklasse) VALUES
('Milchprodukte', 7),
('Süßigkeiten', 44),
('Vorgearbeitetes Futter', 42);

INSERT INTO Filiale (FilialeNr, Name, Strasse, StrasseNr, OrtNr) VALUES
...
INSERT INTO Kasse (KasseNr, FilialeNr) VALUES
(1, 2),
(2, 2),
(3, 1);

INSERT INTO Mitarbeiter (MitarbeiterNr, Name, FilialeNr) VALUES
(1, 'Gertrude', 3),
(2, 'Tilo', 1),
(3, 'Klaus', 2);

INSERT INTO Einkauf (EinkaufNr, Uhrzeit, Datum, Rabatt_Prozent, KasseNr) VALUES
...
INSERT INTO Lieferant (LieferantNr, Name, Strasse, StrasseNr, OrtNr) VALUES
(1, 'Döner an der Ecke', 'Ringelstraße', '69', 420),
(2, 'Molkas Milchkühe', 'Bayrische Alp', '99988', 8033),
(3, 'Nestle', 'Stuhlstraße', '100', 9121929);

INSERT INTO EC_Zahlung (EC_ZahlungsNr, IBAN, Betrag, Karteninhaber, KartenNr) VALUES
